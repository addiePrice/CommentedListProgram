...
"""
Function explanation:
This function finds the user's desired by continuously removing the half of the list that does not contain the value.
To do this, it defines 3 variables: low, high, and mid. mid is the averge of low and high.
...
midpoint of the list by averaging high and low. The if statement says that if the desired values position is in the top half of the list,
